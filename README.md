以下是为该 GOST 一键管理脚本编写的 README.md 教程和介绍文档。
...
3) 自适应 同一端口同时支持 HTTP 和 SOCKS5（推荐） http://user:pass@ip:port 或 socks5://...
...
这份 README 涵盖了脚本的**安装、使用、常见问题、支持环境**等核心信息，可直接放在 GitHub 仓库根目录。如果需要调整格式或补充内容，请告知。
